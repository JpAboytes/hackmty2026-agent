...
The orchestrator spawns the sibling repository's server as a stdio subprocess
per request, using that repository's own virtualenv and working directory so
its `.env` (SUPABASE_DATABASE_URL, MCP_ALLOWED_TABLES, ...) resolves normally.
"""
...
_DEFAULT_MCP_DIR = os.path.normpath(os.path.join(_THIS_DIR, "..", "hackmty2026-mcp"))
